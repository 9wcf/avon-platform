...
class _HomeContentState extends State<HomeContent> {
  ...
  Future<void> _showNotifDropdown() async {
    ...
    await showMenu<Map<String, dynamic>?>(
      ...
      if (value != null) {
        // ضغط على إشعار معين → علّمه كمقروء
  ...
  Widget _offerCard(Map<String, dynamic> offer) {
    ...
    return GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => BookingScreen(serviceName: (offer['title_ar'] ?? '').toString()))),
            child: Container(
            width: 280,
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [Flexible(child: Text(offer['discounted_price'].toString() + ' د.ع', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: Colors.white, fontFamily: 'Tajawal'), overflow: TextOverflow.ellipsis)), const SizedBox(width: 10), Text(offer['original_price'].toString() + ' د.ع', style: TextStyle(fontSize: 12, color: Colors.white.withOpacity(0.7), decoration: TextDecoration.lineThrough, fontFamily: 'Tajawal'))]),
                ],
              ),
            ),
          ],
